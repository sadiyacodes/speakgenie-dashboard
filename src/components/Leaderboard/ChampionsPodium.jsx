...
export default function ChampionsPodium({ champions }) {
  return (
    <div className="rounded-xl shadow border mb-12">
      <div className="rounded-xl w-full p-2 bg-yellow-100">
      ...
      <div className="flex justify-center items-end gap-10 mt-15 p-8 relative">
