...
export default function NotificationSettings({ notifications }) {
  ...
  return (
    <div>
      <div className="bg-white p-8 rounded-xl shadow border mb-8">
      ...
      <div className="bg-white p-8 rounded-xl shadow border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <button
                  key={text}
                  className="flex items-center gap-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 font-medium hover:bg-gray-200 transition"
                >
                  <Download size={18} />
                  {text}
                </button>
          ...
          <div>
            ...
            <button className="flex items-center gap-2 px-4 py-2 bg-gray-100 border border-gray-300 rounded-md text-gray-700 font-medium hover:bg-gray-200 transition mb-3">
